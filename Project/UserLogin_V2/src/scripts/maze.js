...
function setup(){
   ...
   exportButton.position(530, 500);
   //exportButton.style('position', 'absolute');
   //exportButton.style('top', '700x');
...
function keyPressed() {
  ...
  if(current.exit){
     ...
     victoryMessage.position(750,300);
     victoryMessage.style('color', 'white');
     victoryMessage.style('background-color', 'black');
